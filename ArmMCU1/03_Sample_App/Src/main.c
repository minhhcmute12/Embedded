...
/**
 * Chương trình ví dụ các lựa chọn khi debugging code
 */
#include<stdio.h>
#include<stdlib.h>
#include<string.h>
...
/**
 * Điền một value bất kỳ (<1000) vào mảng
 */
...
/**
 * Đổi value của 2 vị trí con trỏ
 */
