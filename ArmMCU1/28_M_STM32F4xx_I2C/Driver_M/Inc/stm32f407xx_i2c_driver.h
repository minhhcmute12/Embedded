 ...
 * Thông số do người dùng cấu hình thông số input khi khởi tạo I2C peripheral
 */
typedef struct
{
...
/**
 * Handle structure for I2Cx peripheral - Cấu hình cấu trúc cho ngoại vi I2C
 */
typedef struct
{
	I2C_RegDef_t *pI2Cx;				//Cấu hình thanh ghi
	I2C_Config_t I2C_Config;			//Cấu hình thông số I2C do user khởi tạo ban đầu
}I2C_Handle_t;

/****************************************************************************************
 *		Definition For more information about the I2C_Config_t of variable 				*
 ****************************************************************************************/
/**
 * @I2C_SCLSpeed
 */
 ...
 */
#define I2C_FM_DUTY_2			0				/* 0: Fm mode tlow/thigh = 2 */
#define I2C_FM_DUTY_16_9		1				/* Fm mode tlow/thigh = 16/9 (see CCR) */
...
uint8_t I2C_GetFlagStatus(I2C_RegDef_t *pI2Cx, uint32_t FlagName);			//Kiểm tra trạng thái các flag trong thanh ghi SR1
uint8_t I2C_GetFlagStatusSR2(I2C_RegDef_t *pI2Cx, uint32_t FlagName);		//Kiểm tra trạng thái các flag trong thanh ghi SR2
void I2C_ManageAcking(I2C_RegDef_t *pI2Cx, uint8_t EnorDi);					//Quản lý bit Acking
