/*
 * 12_i2c_slave_tx_stringMax.c
 *
 *  Created on: Jan 9, 2024
 *      Author: Minh
 *
 *  Bài tập hỗ trợ việc gửi nội dung data có độ dài hơn 32byte
 *  Cách làm: tách nội dung đó làm 32+32+..+x(x phần dư, pp chia lấy dư)
 *  mỗi lần gửi 32 byte và đến lần cuối gửi x byte
 */
