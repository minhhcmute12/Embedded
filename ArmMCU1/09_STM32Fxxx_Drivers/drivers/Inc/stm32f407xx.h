 ...
 */
#define FLASH_BASEADDR		0x08000000U		//Table5(Phần 3, Reference manual)
#define SRAM1_BASEADDR		0x20000000U		//Phần 2.3.1 Embedded SRAM address - Reference manual
#define SRAM2_BASEADDR		0x2001C000U		//'U': thông báo cho trình biên dịch đây là số nguyên kiểu int, uint32_t
...
/**
 * 2_AHBx and APBx Bus Peripheral address(Table 10. register boundary addresses - datasheet_stm32f407.pdf)
 */
...
//Giải thích: PERIPH_BASE == APB1PERIPH_BASE vì theo Figure 18. STM32F40xxx memory map thì thanh ghi APB1 là thanh ghi bắt đầu
...
#define GPIOB_BASEADDR		(AHB1PERIPH_BASE + 0x0400) 		//0x0400 là phần offset: 0x4002 0400(GPIOB) - 0x4002 0000(GPIOA) = 0x0400
...
#define GPIOC_PCLK_EN() 		(RCC->AHB1ENR |= (1 << 2))		//Cho bit1(GPIOC) thanh ghi AHB1ENR lên 1
